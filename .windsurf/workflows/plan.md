...
- `.specs/_stack.json`.
- `.windsurf/templates/design.template.md`, `.windsurf/templates/tasks.template.md`, `.windsurf/templates/adr.template.md`.
- Epic mode: `.windsurf/templates/epic-design.template.md`, `.windsurf/templates/epic-roadmap.template.md`.
