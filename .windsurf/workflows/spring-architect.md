---
description: "spring-architect — see .windsurf/workflows/spring-architect.md"
---
...
3. **If Epic mode, draft Epic artifacts first** from `.windsurf/templates/epic-design.template.md` and `.windsurf/templates/epic-roadmap.template.md`.
4. **Draft `03-design.md`** from `.windsurf/templates/design.template.md` (for a target slice in Epic mode, or full feature in non-Epic mode). Cover:
...
6. **Decompose into tasks** in `04-tasks.md` per `spring-task-decomposition`. Each task:
   ...
   - Required gates
7. **Self-review** with `.windsurf/checklists/design-review.md`.
